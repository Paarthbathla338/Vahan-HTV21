...
export default function Categories() {
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', padding: 15, backgroundColor: '#00b3b3', borderBottomRightRadius: 35, borderBottomLeftRadius: 35}}>
